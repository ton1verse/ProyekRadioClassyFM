...
import { Phone, Mail, Facebook, Instagram, Youtube, Link2, MapPin, Building2, PhoneCall } from 'lucide-react';
            ...
            <div className="container mx-auto px-6 mb-12"   >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="flex flex-col gap-6">
                        {/* Map Embed */}
                        <div className="w-full h-48 bg-gray-200 rounded-lg overflow-hidden relative group shadow-lg">
                            <iframe
                                src="https://maps.google.com/maps?q=Classy+103.4+FM+Padang&t=&z=15&ie=UTF8&iwloc=&output=embed"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                ...
                                title="Classy FM Location"
                            ></iframe>
                        </div>

                        <div>
                            <div className="flex items-start gap-3 mb-2">
                                <Building2 className="w-6 h-6 text-[#A12227] flex-shrink-0 mt-1" />
                                <h4 className="font-bold text-2xl text-white">
                                    PT. Radio Gema Karang Putih
                                </h4>
                            </div>
                            <div className="flex items-start gap-3">
                                <MapPin className="w-6 h-6 text-[#A12227] flex-shrink-0 mt-1" />
                                <p className="text-lg leading-relaxed text-white/90">
                                    Jalan Raya Indarung GSG,<br />
                                    Komp. PT Semen Padang LT II,<br />
                                    Indarung, Kec. Lubuk Kilangan,<br />
                                    Kota Padang, Sumatera Barat 25237
                                </p>
                            </div>
                        </div>
                    </div>
